...
- [Quickstart](../getting-started/quickstart.md) — First test walkthrough
- [Configuration](configuration.md) — LLMConfig, Persona, AppManifest
- [API: Core Protocols](../api/core-protocols.md) — Protocol reference
- [API: Evaluators](../api/evaluators.md) — Evaluator API details
